...
import { Bell, Building2Icon, Loader2, MessageCircle, Plus, Search } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
    ...
    <>
      {isLoggingOut && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[9999] flex flex-col items-center justify-center text-white">
          ...
          <p className="text-xl font-medium animate-pulse text-pink-100">
            Logging you out...
          </p>
        </div>
      )}
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <Link href="/" className="cursor-pointer" scroll={false}>
              <div className="flex items-center gap-3">
                <Building2Icon size={28} className="text-black hover:text-blue-400 -mr-2" />
                <div className="text-xl font-bold">
                  <span className= "text-orange-300 hover:text-black">PRIME</span>
